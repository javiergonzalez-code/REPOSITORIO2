            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 bg-white">
                <div class="card-body p-4 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h2 class="audit-title mb-0" style="font-size: 1.5rem; font-weight: 800; color: #1e293b;">GESTIÓN DE ÓRDENES</h2>
                    ...
                    <form action="{{ route('oc.index') }}" method="GET" class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-2 col-md-6">
                            ...
                            <select name="extension" class="form-input">
                                ...
                                <option value="json" {{ request('extension') == 'json' ? 'selected' : '' }}>JSON</option>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0 ml-5">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="5" class="text-center py-5 fw-bold text-muted">No hay registros</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>

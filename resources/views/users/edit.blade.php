                ...
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="d-flex align-items-center mt-5 mb-4">
                            ...
                            <span class="badge bg-info-light text-primary border border-info px-3 rounded-pill" style="font-size: 0.7rem; background-color: #e0f2fe;">
                                Opcional
                            </span>
                        </div>

                        <div class="alert alert-custom mb-4" role="alert" style="background-color: #f0f9ff; border-left: 4px solid #3b82f6; border-radius: 4px; padding: 12px 20px;">
                            <div class="d-flex align-items-center text-primary">
                                <i class="fas fa-info-circle fa-lg me-3"></i>
                                <span class="small fw-semibold">Solo rellene estos campos si desea cambiar la contraseña actual del usuario.</span>
                            </div>
                        </div>

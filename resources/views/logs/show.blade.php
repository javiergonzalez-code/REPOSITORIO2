        ...
        <div class="container-fluid py-4">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 custom-card bg-white">
                        {{-- Encabezado --}}
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-4 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex align-items-center p-3 rounded-3 border gap-3 h-100" style="background-color: #ffffff !important; box-shadow: none !important;">
                                        {{-- Círculo del Avatar --}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="p-3 rounded-3 border d-flex flex-column justify-content-center h-100" style="background-color: #ffffff !important; box-shadow: none !important;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="badge text-dark border fw-bold px-3 py-2"
                                        style="font-size: 0.85rem; background-color: #ffffff !important; box-shadow: none !important;">
                                        <i class="fas fa-cube me-1 text-primary"></i> {{ $log->modulo ?? 'N/A' }}
                                    </span>
                                </div>

                                {{-- Acción (CON COLOR DINÁMICO Y FONDO BLANCO PURO) --}}
                                <div class="col-md-12">
                                    <label class="text-muted fw-bold text-uppercase x-small d-block mb-2"
                                        style="font-size: 0.7rem; letter-spacing: 0.5px;">
